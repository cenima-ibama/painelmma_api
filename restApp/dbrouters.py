class SiscomRouter(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        """
        if model._meta.app_label == 'restApp':
            return 'siscom_db'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        """
        if obj1._meta.app_label == 'restApp' or \
            obj2._meta.app_label == 'restApp':
            return True
        return None
    ...
    def allow_migrate(self, db, model):
        ...
        """
        if db == 'catalogo_db':
            return model._meta.app_label == 'restApp'
        elif model._meta.app_label == 'restApp':
            return False
        return None